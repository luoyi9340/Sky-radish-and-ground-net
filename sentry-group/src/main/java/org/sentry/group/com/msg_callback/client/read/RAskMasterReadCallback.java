 ...
 *
 */
public class RAskMasterReadCallback extends AClientMsgCallback<RAskMasterMsg> implements IMsgReadCallback<RAskMasterMsg> {

	
	public RAskMasterReadCallback() {super();}
	public RAskMasterReadCallback(IWaitReceiptQueue queue, CommunicationList.Info info, ComConnectHolder holder) {super(queue, info, holder);}
