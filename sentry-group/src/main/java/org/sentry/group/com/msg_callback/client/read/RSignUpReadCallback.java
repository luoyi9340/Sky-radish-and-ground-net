 ...
 *
 */
public class RSignUpReadCallback extends AClientMsgCallback<RSignUpMsg> implements IMsgReadCallback<RSignUpMsg> {
	...
	public RSignUpReadCallback(IWaitReceiptQueue queue, CommunicationList.Info info, ComConnectHolder holder) {super(queue, info, holder);}
