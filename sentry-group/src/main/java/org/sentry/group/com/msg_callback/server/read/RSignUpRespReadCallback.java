 ...
 *
 */
public class RSignUpRespReadCallback extends AServerMsgCallback<RSignUpRespMsg> implements IMsgReadCallback<RSignUpRespMsg> {
	...
	public RSignUpRespReadCallback(IWaitReceiptQueue queue) {super(queue);}
	...
	public void callbackHandly(ChannelHandlerContext ctx, RSignUpRespMsg msg) {
		...
		//	否则确认报名参加对方决议
			...
			log.info("报名消息跟踪: 收到对方报名，丢给com处理. msg:" + msg);
