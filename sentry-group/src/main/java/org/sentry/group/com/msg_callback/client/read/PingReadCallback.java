 ...
 *
 */
public class PingReadCallback extends AClientMsgCallback<PingMsg> implements IMsgReadCallback<PingMsg> {
	...
	public PingReadCallback(IWaitReceiptQueue queue, CommunicationList.Info info, ComConnectHolder holder) {super(queue, info, holder);}
